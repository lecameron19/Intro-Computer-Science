...
let questionWord = "WHY IN THE WORLD WOULD YOU DO THAT"
let connectorWord = "WHAT?!"
let question = "\(connectorWord) \(questionWord)?"

let incessantQuestion = "\(questionWord)? \(questionWord)? \(questionWord)? \(questionWord)?"

let name = "Tiffany"
let summons = "\(name)? \(name)!!"

let botheration = "\(question) \(summons)"
