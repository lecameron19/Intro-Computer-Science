...
let totalTime = (chooseClothes + getDressed + checkMedias + packBackpack + brushTeeth + doDishes + showerTime)
...
let needToDo = (getDressed + brushTeeth + packBackpack + doDishes)
let likeToDo = (checkMedias + chooseClothes + showerTime)
/*:
